"""
This file contains the description of a job that downloads a given file in parallel. It takes as arguments the url
where the file is located, the number of cores available for downloading and the directory where to save the
downloaded file.

The original source of this script is
...
if __name__ == '__main__':
    ...
    For ex.:
        1. obj = Downloader("https://storage.googleapis.com/vimeo-test/work-at-vimeo-2.mp4", "out_file.mp4", 10)
        2. obj = Downloader("http://i.imgur.com/z4d4kWk.jpg", "out_file.jpg" 3)
